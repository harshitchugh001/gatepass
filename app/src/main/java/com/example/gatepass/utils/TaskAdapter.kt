...
import com.example.gatepass.databinding.EachItemBinding
import com.example.gatepass.utils.ToDoData
//import com.example.gatepass.databinding.EachTodoItemBinding
...
class TaskAdapter(private val list: MutableList<ToDoData>) : RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {
    ...
    class TaskViewHolder(val binding: EachItemBinding) : RecyclerView.ViewHolder(binding.root)
